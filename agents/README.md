...
| --- | --- | --- | --- |
| [add-integration](../.agents/skills/add-integration/SKILL.md) | workflow | Connect a tool the team uses by the MCP, CLI, script ladder in integrations/adding-an-integration.md, as one PR | nothing |
...
| [make-dashboard](../.agents/skills/make-dashboard/SKILL.md) | workflow | Turn data into a self-contained HTML dashboard beside its report, or a spec for the team's BI tool | nothing (optional: [warehouse-bi](../integrations/catalog/README.md#warehouse-bi)) |
...
| Skill | Kind | What it does | Needs |
| --- | --- | --- | --- |
| [competitor-watch](../.agents/skills/competitor-watch/SKILL.md) | role (monthly) | Track what changed on each competitor's pricing, positioning, product and ad-library pages since last month; flag battlecards to refresh | nothing (optional: [scraping-search](../integrations/catalog/README.md#scraping-search)) |
| [apify-easy-competitive-intelligence](../.agents/skills/apify-easy-competitive-intelligence/SKILL.md) | workflow | Competitor deep dive from live pricing, review, hiring, content and news data | [scraping-search](../integrations/catalog/README.md#scraping-search) (optional: [seo-data](../integrations/catalog/README.md#seo-data), [surveys-reviews](../integrations/catalog/README.md#surveys-reviews)) |
| [apify-ecommerce](../.agents/skills/apify-ecommerce/SKILL.md) | workflow | Product, price, review, bestseller and seller data from Amazon, Walmart, eBay, Shopify and more | [scraping-search](../integrations/catalog/README.md#scraping-search) |
| [battlecard](../.agents/skills/battlecard/SKILL.md) | workflow | Write or refresh a competitor battlecard in strategy/competitive/; public claims are data, pricing and customers never invented | nothing (optional: [seo-data](../integrations/catalog/README.md#seo-data), [context-layer](../integrations/catalog/README.md#context-layer)) |
...
| [launch-plan](../.agents/skills/launch-plan/SKILL.md) | workflow | Plan a product or feature launch: tier, narrative, channel plan, assets and owners, as a project folder plus content stubs | nothing (optional: [tasks](../integrations/catalog/README.md#tasks)) |
...
| [persona-builder](../.agents/skills/persona-builder/SKILL.md) | workflow | Write or refresh a persona in strategy/personas.md from interviews, CRM facts and customer language, never stereotypes | nothing (optional: [transcripts](../integrations/catalog/README.md#transcripts), [context-layer](../integrations/catalog/README.md#context-layer)) |
| [positioning-refresh](../.agents/skills/positioning-refresh/SKILL.md) | workflow | Propose a reviewed update to strategy/positioning.md from decisions, win/loss and competitive evidence, listing what inherits it | nothing (optional: [context-layer](../integrations/catalog/README.md#context-layer)) |
...
| [content-inventory](../.agents/skills/content-inventory/SKILL.md) | workflow | List what content exists by channel, status, owner, age and topic, and what to reuse or not duplicate | nothing |
...
| [review](../.agents/skills/review/SKILL.md) | workflow | Pre-publish review of a draft against strategy, messaging and brand voice; findings only, no rewrite unless asked | nothing (optional: [context-layer](../integrations/catalog/README.md#context-layer)) |
...
| [seo-analyst](../.agents/skills/seo-analyst/SKILL.md) | role (weekly) | Keyword and ranking analysis against data/seo/keywords.csv through the wired seo-data integration, saved as dated snapshots | [seo-data](../integrations/catalog/README.md#seo-data) |
| [apify-link-prospecting-outreach](../.agents/skills/apify-link-prospecting-outreach/SKILL.md) | workflow | Link prospects for a keyword with authority, contacts, a pitch angle and a draft email each | [scraping-search](../integrations/catalog/README.md#scraping-search) (optional: [seo-data](../integrations/catalog/README.md#seo-data)) |
...
| [apify-ai-search-visibility-tracker](../.agents/skills/apify-ai-search-visibility-tracker/SKILL.md) | workflow | Prompts that surface competitors in AI answers, citation gaps and a mentions snapshot via scraping | [scraping-search](../integrations/catalog/README.md#scraping-search) (optional: [ai-visibility](../integrations/catalog/README.md#ai-visibility)) |
...
| [apify-ads-intelligence](../.agents/skills/apify-ads-intelligence/SKILL.md) | workflow | Competitor ad creatives, angles and landing pages from the Meta, Google, TikTok, LinkedIn and X ad libraries | [scraping-search](../integrations/catalog/README.md#scraping-search) (optional: [ads](../integrations/catalog/README.md#ads)) |
| [campaign-discovery](../.agents/skills/campaign-discovery/SKILL.md) | workflow | Discovery for a campaign idea in one sentence: competitive angle, keywords and ranks, AI answer coverage, existing content, one report | nothing (optional: [seo-data](../integrations/catalog/README.md#seo-data), [ai-visibility](../integrations/catalog/README.md#ai-visibility)) |
| [campaign-plan](../.agents/skills/campaign-plan/SKILL.md) | workflow | Turn a discovery report into a campaign: narrative, channels with retargeting audiences, budget, calendar, KPIs, owners | nothing (optional: [tasks](../integrations/catalog/README.md#tasks)) |
...
| Skill | Kind | What it does | Needs |
| --- | --- | --- | --- |
| [account-signals](../.agents/skills/account-signals/SKILL.md) | role (weekly) | Weekly account heat: intent, web and CRM engagement per target account, buying-group coverage, who to hand to sales | [crm](../integrations/catalog/README.md#crm) (optional: [intent](../integrations/catalog/README.md#intent), [web-analytics](../integrations/catalog/README.md#web-analytics)) |
| [researcher](../.agents/skills/researcher/SKILL.md) | role (on-demand) | Account research through the wired scraping and enrichment tools, saved as snapshots in data/accounts/, or a pre-call brief from them | [scraping-search](../integrations/catalog/README.md#scraping-search) (optional: [crm](../integrations/catalog/README.md#crm), [enrichment](../integrations/catalog/README.md#enrichment)) |
| [apify-buying-signal-detection](../.agents/skills/apify-buying-signal-detection/SKILL.md) | workflow | Companies in market this week from job posts, funding and LinkedIn posts, matched to the ICP | [scraping-search](../integrations/catalog/README.md#scraping-search) (optional: [crm](../integrations/catalog/README.md#crm), [enrichment](../integrations/catalog/README.md#enrichment), [intent](../integrations/catalog/README.md#intent)) |
| [apify-google-maps-leads](../.agents/skills/apify-google-maps-leads/SKILL.md) | workflow | Local-business lead lists from Google Maps with website contacts and an optional review score | [scraping-search](../integrations/catalog/README.md#scraping-search) (optional: [crm](../integrations/catalog/README.md#crm), [enrichment](../integrations/catalog/README.md#enrichment)) |
| [apify-lead-scoring-enrichment](../.agents/skills/apify-lead-scoring-enrichment/SKILL.md) | workflow | Score a CSV of domains against plain-English fit rules, then enrich the qualified with contacts and a hook | [scraping-search](../integrations/catalog/README.md#scraping-search) (optional: [enrichment](../integrations/catalog/README.md#enrichment), [crm](../integrations/catalog/README.md#crm)) |
| [apify-verified-email-finder](../.agents/skills/apify-verified-email-finder/SKILL.md) | workflow | Verified business emails for a domain list, a topic or a local-business query in one run | [scraping-search](../integrations/catalog/README.md#scraping-search) (optional: [enrichment](../integrations/catalog/README.md#enrichment)) |
...
| [event-plan](../.agents/skills/event-plan/SKILL.md) | workflow | Plan a webinar, sponsorship, speaking slot or attended event: goal, target accounts, funnel, assets, ROI model, CFP | nothing (optional: [events](../integrations/catalog/README.md#events), [tasks](../integrations/catalog/README.md#tasks)) |
<!-- /generated:skills-events -->
...
| Skill | Kind | What it does | Needs |
| --- | --- | --- | --- |
| [apify-creator-emails](../.agents/skills/apify-creator-emails/SKILL.md) | workflow | Creator outreach list for a niche across YouTube, TikTok and Instagram with verified emails | [scraping-search](../integrations/catalog/README.md#scraping-search) |
| [apify-influencer-brand-collabs](../.agents/skills/apify-influencer-brand-collabs/SKILL.md) | workflow | Instagram paid-partnership history from the Ad Library, brand or creator side | [scraping-search](../integrations/catalog/README.md#scraping-search) |
...
| Skill | Kind | What it does | Needs |
| --- | --- | --- | --- |
| [chief-of-staff](../.agents/skills/chief-of-staff/SKILL.md) | role (on-demand) | Process transcripts from memory/transcripts/inbox/ into facts, decisions, status updates, action items per owner and red flags | nothing (optional: [transcripts](../integrations/catalog/README.md#transcripts), [tasks](../integrations/catalog/README.md#tasks), [chat](../integrations/catalog/README.md#chat)) |
| [context-freshness](../.agents/skills/context-freshness/SKILL.md) | role (monthly) | Monthly judgment pass on context: files past 90 days, contradictions between strategy, knowledge and the decision log, which refresh to run | nothing (optional: [context-layer](../integrations/catalog/README.md#context-layer)) |
...
| [qmr](../.agents/skills/qmr/SKILL.md) | workflow | Assemble the Quarterly Marketing Review: the data checklist, snapshots or human exports, deltas versus last quarter, the report and dashboard | nothing (optional: [crm](../integrations/catalog/README.md#crm), [web-analytics](../integrations/catalog/README.md#web-analytics), [ads](../integrations/catalog/README.md#ads), [marketing-automation](../integrations/catalog/README.md#marketing-automation), [seo-data](../integrations/catalog/README.md#seo-data)) |
<!-- /generated:skills-leadership -->
