...
Guides for running your marketing from this repo, in reading order.
...
- [new-to-github.md](new-to-github.md): start here if you have never used GitHub. No terminal required.
- [workflow.md](workflow.md): how agent-proposed work gets reviewed and merged.
