...
description: Propose a reviewed update to strategy/positioning.md from decisions, win/loss and competitive evidence, listing what inherits it. Use when "refresh positioning", or when context-freshness flags it.
license: MIT
metadata:
  kind: workflow
