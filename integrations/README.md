...
| [enrichment](catalog/README.md#enrichment) | contact and company data: enriching target accounts and people in data/accounts | not wired | Apollo.io, Clay, ZoomInfo, Lusha, Hunter.io, FullEnrich, Dropcontact, People Data Labs, Clearbit (HubSpot Breeze Intelligence), Cognism (falls back to generic) | (+8 optional) |
| [intent](catalog/README.md#intent) | intent and signal data: which target accounts are in market, joined to data/accounts | not wired | Common Room, Demandbase, 6sense, G2 Buyer Intent, Warmly, RB2B, Bombora, Vector (falls back to generic) | (+2 optional) |
...
| [scraping-search](catalog/README.md#scraping-search) | web scraping, actor runs, web and news search, page reading for ABM research and monitoring | Apify | Apify, Firecrawl, Exa, Tavily, Brave Search, Perplexity, Jina Reader, Bright Data, Browserbase (falls back to generic) | [apify-ads-intelligence](../.agents/skills/apify-ads-intelligence/SKILL.md), [apify-ai-search-visibility-tracker](../.agents/skills/apify-ai-search-visibility-tracker/SKILL.md), [apify-buying-signal-detection](../.agents/skills/apify-buying-signal-detection/SKILL.md), [apify-creator-emails](../.agents/skills/apify-creator-emails/SKILL.md), [apify-easy-competitive-intelligence](../.agents/skills/apify-easy-competitive-intelligence/SKILL.md), [apify-ecommerce](../.agents/skills/apify-ecommerce/SKILL.md), [apify-google-maps-leads](../.agents/skills/apify-google-maps-leads/SKILL.md), [apify-influencer-brand-collabs](../.agents/skills/apify-influencer-brand-collabs/SKILL.md), [apify-lead-scoring-enrichment](../.agents/skills/apify-lead-scoring-enrichment/SKILL.md), [apify-link-prospecting-outreach](../.agents/skills/apify-link-prospecting-outreach/SKILL.md), [apify-verified-email-finder](../.agents/skills/apify-verified-email-finder/SKILL.md), [researcher](../.agents/skills/researcher/SKILL.md) (+5 optional) |
