---
name: chief-of-staff
description: Process transcripts from memory/transcripts/inbox/ into facts, decisions, status updates, action items per owner and red flags. Use when "process the transcript inbox", "process this meeting".
license: MIT
metadata:
  kind: role
  area: leadership
