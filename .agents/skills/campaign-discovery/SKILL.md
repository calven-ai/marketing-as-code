...
description: Discovery for a campaign idea in one sentence: competitive angle, keywords and ranks, AI answer coverage, existing content, one report. Use when "explore a campaign", "run discovery on".
license: MIT
metadata:
  kind: workflow
  area: paid
