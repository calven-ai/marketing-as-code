<!-- source: https://raw.githubusercontent.com/apify/awesome-skills/bcb7fb8935d2f36f0ec4143fe3a40efc0c191f0b/skills/apify-easy-competitive-intelligence/SKILL.md | license: Apache-2.0 | fetched: 2026-09-14 -->
...
1. **Read** — find the actor's section in `references/actor-schemas.md`. Use the exact verified input and follow the "How to find" instructions for URLs/slugs.
...
2. **Read module reference** — Load `references/modules/<module>.md` for gathering + analysis instructions.
...
6. **Verify** — Run pre-delivery verification (`references/verification-checklist.md`). Check: every claim has a source URL, every major finding has a confidence label, inferences are labeled as such. Remove any ungrounded claims.
