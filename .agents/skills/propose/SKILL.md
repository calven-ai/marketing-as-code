---
name: propose
description: Turn what changed into a proposal (a pull request) and hand back the link. Use when asked to "propose", "send this for review", "ship it", or when work is done and should land.
license: MIT
metadata:
  kind: workflow
  area: core
