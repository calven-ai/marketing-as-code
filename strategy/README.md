...
| File | Owns |
| --- | --- |
| [positioning.md](positioning.md) | Category, for-whom, differentiation, proof |
| [messaging.md](messaging.md) | The messaging hierarchy: narrative → pillars → proof points |
| [icp-personas.md](icp-personas.md) | Ideal customer profile and buyer/user personas |
| [competitive/](competitive/) | Competitor notes and battlecards, one file per competitor |

## Rules

- Keep it current: everything downstream (content, campaigns, prototypes)
  inherits from these files. When positioning changes, it changes here first.
