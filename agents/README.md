...
| --- | --- | --- | --- |
| [add-integration](../.agents/skills/add-integration/SKILL.md) | workflow | Connect a tool the team uses by the MCP, CLI, script ladder in integrations/adding-an-integration.md, as one reviewable PR | nothing |
...
| [apify-easy-competitive-intelligence](../.agents/skills/apify-easy-competitive-intelligence/SKILL.md) | workflow | Competitor deep dive: pricing, reviews, hiring and content signals in one pass | [scraping-search](../integrations/catalog/README.md#scraping-search) |
| [apify-ecommerce](../.agents/skills/apify-ecommerce/SKILL.md) | workflow | Product, pricing and review data from Amazon, Walmart, eBay, Shopify and 30 more | [scraping-search](../integrations/catalog/README.md#scraping-search) |
| [battlecard](../.agents/skills/battlecard/SKILL.md) | workflow | Write or refresh a competitor battlecard in strategy/competitive/ from the template; public claims are data, pricing and customers never invented | nothing (optional: [seo-data](../integrations/catalog/README.md#seo-data), [context-layer](../integrations/catalog/README.md#context-layer)) |
...
| [positioning-refresh](../.agents/skills/positioning-refresh/SKILL.md) | workflow | Propose a reviewed update to strategy/positioning.md from decisions, win/loss and competitive evidence, listing what inherits the change | nothing (optional: [context-layer](../integrations/catalog/README.md#context-layer)) |
...
| [apify-link-prospecting-outreach](../.agents/skills/apify-link-prospecting-outreach/SKILL.md) | workflow | Find link prospects, their contact details and a pitch angle per target | [scraping-search](../integrations/catalog/README.md#scraping-search) |
...
| [apify-ai-search-visibility-tracker](../.agents/skills/apify-ai-search-visibility-tracker/SKILL.md) | workflow | Track brand and competitor citations in AI Overviews, ChatGPT, Perplexity and Gemini on a schedule | [scraping-search](../integrations/catalog/README.md#scraping-search) |
...
| [apify-ads-intelligence](../.agents/skills/apify-ads-intelligence/SKILL.md) | workflow | Competitor ad creatives and spend from the Meta, Google, TikTok, LinkedIn and X ad libraries | [scraping-search](../integrations/catalog/README.md#scraping-search) |
| [campaign-discovery](../.agents/skills/campaign-discovery/SKILL.md) | workflow | Discovery for a campaign idea in one sentence: competitive angle, keywords and ranks, AI answer coverage, existing content, one report in reports/adhoc/ | nothing (optional: [seo-data](../integrations/catalog/README.md#seo-data), [ai-visibility](../integrations/catalog/README.md#ai-visibility)) |
...
| [apify-buying-signal-detection](../.agents/skills/apify-buying-signal-detection/SKILL.md) | workflow | Find accounts showing intent from job posts, funding events and LinkedIn activity | [scraping-search](../integrations/catalog/README.md#scraping-search) |
| [apify-google-maps-leads](../.agents/skills/apify-google-maps-leads/SKILL.md) | workflow | Local-business lead lists from Google Maps, enriched with contacts from each site | [scraping-search](../integrations/catalog/README.md#scraping-search) |
| [apify-lead-scoring-enrichment](../.agents/skills/apify-lead-scoring-enrichment/SKILL.md) | workflow | Score and enrich a CSV of leads with tech stack, contacts and a per-lead outreach hook | [scraping-search](../integrations/catalog/README.md#scraping-search) |
| [apify-verified-email-finder](../.agents/skills/apify-verified-email-finder/SKILL.md) | workflow | Find and MX-verify work emails for a list of names and domains | [scraping-search](../integrations/catalog/README.md#scraping-search) |
...
| Skill | Kind | What it does | Needs |
| --- | --- | --- | --- |
| [apify-creator-emails](../.agents/skills/apify-creator-emails/SKILL.md) | workflow | Build a creator outreach list with verified emails from YouTube, TikTok and Instagram | [scraping-search](../integrations/catalog/README.md#scraping-search) |
| [apify-influencer-brand-collabs](../.agents/skills/apify-influencer-brand-collabs/SKILL.md) | workflow | Instagram brand and creator partnership history, either direction | [scraping-search](../integrations/catalog/README.md#scraping-search) |
