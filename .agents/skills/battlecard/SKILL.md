---
name: battlecard
description: Write or refresh a competitor battlecard in strategy/competitive/; public claims are data, pricing and customers never invented. Use when "battlecard for X", "refresh the Acme card".
license: MIT
metadata:
  kind: workflow
